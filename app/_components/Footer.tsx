...
const COLUMNS = [
  {
    ...
    links: [
      ...
      { label: 'Gói Pro',       href: '/pro'                          },
      { label: 'Đăng tin',      href: '/dashboard/listings/new'       },
    ],
  },
  {
    heading: 'Tỉnh thành',
  ...
  },
  {
    heading: 'Hỗ trợ',
    links: [
      { label: 'Trung tâm hỗ trợ',   href: '/trung-tam-ho-tro'   },
      { label: 'Báo cáo lỗi',        href: '/bao-cao-loi'        },
      { label: 'Quy trình đăng tin',  href: '/quy-trinh-dang-tin' },
      { label: 'Xác minh pháp lý',   href: '/xac-minh-phap-ly'   },
    ],
  },
] as const
